...
namespace SystemDAO
{
    ...
    public abstract class SqlHelperEx
    {
        ...
        /// 数据库连接字符串
        /// </summary>
        public static readonly string connectionString = System.Configuration.ConfigurationManager.ConnectionStrings["connStr"].ConnectionString;
        ...
        {
            return ExecuteScalar(SqlHelperEx.connectionString, cmdType, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteScalar(SqlHelperEx.connectionString, CommandType.StoredProcedure, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteScalar(SqlHelperEx.connectionString, CommandType.Text, cmdText, commandParameters);
        }
