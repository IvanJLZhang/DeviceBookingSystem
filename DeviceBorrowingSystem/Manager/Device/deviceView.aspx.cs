...
public partial class Manager_Device_deviceView : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            Session["Category"] = (Int32)Category.Device;
        }
    }
    ...
    void ShowDeviceTable()
    {
        ...
        DataTable deviceTable = factory.GetDeviceTable(deviceStatus);
    ...
    protected void agv_deviceTable_RowCommand(object sender, DevExpress.Web.ASPxGridView.ASPxGridViewRowCommandEventArgs e)
    {
        if (e.CommandArgs.CommandName.CompareTo("DeviceDetail") == 0)
        {
            ...
            string scriptText = "var obj = window.showModalDialog('.././Equipment/EquipmentDetail.aspx?id=" + deviceId + "&type=edit', '', 'resizable = yes; dialogWidth = 750px'); if(obj != null && obj == 'OK') window.location.href = window.location.href;";
